  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        ...
        <li>
          <input type="text" placeholder="请输入搜索关键字" name="keywords" class="input" style="width:250px; line-height:17px;display:inline-block" value="<?php echo ((isset($_GET['keywords']) && ($_GET['keywords'] !== ""))?($_GET['keywords']):''); ?>"/>
	...
	<?php if(is_array($res)): foreach($res as $key=>$value): ?><tr>
          ...
          <td><font color="#00CC99"><?php echo ($value['goods_name']); ?></font></td>
          <td><font color="#00CC99"><?php echo ($value['cate_name']); ?></font></td>
          <td><font color="#00CC99"><?php echo ($value['brand_name']); ?></font></td>
