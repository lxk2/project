...
<style>
	body { background-image:url('/Public/Admin/images/bg.jpg') }
</style>
...
<div class="leftnav">
  ...
  <h2><span class="icon-user"></span>商品设置</h2>
  <ul style="display:block">
    ...
    <li><a href="<?php echo U('GoodsType/index');?>" target="right"><span class="icon-caret-right"></span>商品模型</a></li>   
  ...
  <ul>
    <li><a href="<?php echo U('News/index');?>" target="right"><span class="icon-caret-right"></span>新闻管理</a></li>
